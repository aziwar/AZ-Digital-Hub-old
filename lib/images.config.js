// Image Configuration - Using local assets
export const imageConfig = {
  // Profile Image - Stored locally
  profile: {
    linkedin: "https://www.linkedin.com/in/ahmedziwar",
    profileImage: "/images/ahmed-ziwar-profile.jpeg", // Local profile image (updated extension)
    fallback: "/images/ahmed-ziwar-profile.jpeg"
  },
  
  // Brand Assets - Your AMZ logo
  brand: {
    logo: "/images/AMZ-logo-tr.png", // Your local logo file (updated path)
    favicon: "/favicon.ico"
  },
